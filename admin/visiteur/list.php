...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                if(isset($_GET["active"]) && $_GET["active"] == "ok"){
                    print'<div class="alert alert-success">
                        Utilisateur valider aver succés
                        </div>
                    ';
                }

                if(isset($_GET["active"]) && $_GET["active"] == "notok"){
                    print'<div class="alert alert-danger">
                        Utilisateur dévalider aver succés
                        </div>
                    ';
                }
            ...
            <td><a class="btn btn-success" href="rendreActive.php?id=' . $Visiteur['id'] . '"> Valider</a>  <a href="supprimerActive.php?id=' . $Visiteur['id'] . '" class="btn btn-danger">Dévalider</a></td>
          </tr>';
                                $i++;
                            }
                            ?>
